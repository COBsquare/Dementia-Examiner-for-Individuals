...
public class Evaluation {
	...
	public void EvaluationofTest(String grammerNumber) throws IOException{
		disableLogMessages();
		speechUsages();
		if(grammerNumber=="Question1"){
