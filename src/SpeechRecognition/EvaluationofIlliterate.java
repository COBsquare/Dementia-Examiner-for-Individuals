...
public class EvaluationofIlliterate {
	...
	String answerToQuestion20;
	String answerToQuestion11;
	String answerToQuestion12;
	String answerToQuestion21="i would have gone if he had gone";
	...
	public void EvaluationofQuestion20() throws IOException{
		disableLogMessages();
		Configuration configuration20 = new Configuration();
		configuration20.setAcousticModelPath("resource:/edu/cmu/sphinx/models/en-us/en-us");
		configuration20.setDictionaryPath("resource:/edu/cmu/sphinx/models/en-us/cmudict-en-us.dict");
		configuration20.setGrammarPath("resource:/Grammer");
		configuration20.setGrammarName("Question20");
		configuration20.setUseGrammar(true);
		StreamSpeechRecognizer recognizer20 = new StreamSpeechRecognizer(configuration20);
	...
	public void EvaluationofQuestion21() throws IOException{
		disableLogMessages();
		Configuration configuration21 = new Configuration();
		configuration21.setAcousticModelPath("resource:/edu/cmu/sphinx/models/en-us/en-us");
		configuration21.setDictionaryPath("resource:/edu/cmu/sphinx/models/en-us/cmudict-en-us.dict");
		configuration21.setGrammarPath("resource:/Grammer");
		configuration21.setGrammarName("Question21");
		configuration21.setUseGrammar(true);
		StreamSpeechRecognizer recognizer21 = new StreamSpeechRecognizer(configuration21);
...
public EvaluationofIlliterate() throws IOException{
		...
		EvaluationofQuestion20();
		EvaluationofQuestion21();
